...
class IzlCita(models.Model):
    ...
    cliente_id = fields.Many2one('izl_peluqueria.cliente', string='Cliente', required=True, tracking=True)
    servicio_id = fields.Many2one('izl_peluqueria.servicio', string='Servicio', required=True, tracking=True)
    empleado_id = fields.Many2one('izl_peluqueria.empleado', string='Empleado', required=True, tracking=True)
    fecha = fields.Datetime(string='Fecha y hora', required=True, tracking=True)
